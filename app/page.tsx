...
export default function defaultPage() {
  return (
    <main id="main-content" className="bg-card text-foreground p-8 flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <div className="bg-muted rounded-xl p-6 shadow-md mb-6 max-w-lg w-full">
        ...
        <ul className="list-disc list-inside text-left text-base space-y-1">
          <li>Head to <span className="font-semibold">Bags</span> to create your bag and fill it with clubs.</li>
          <li>Visit <span className="font-semibold">Clubs</span> to add, edit, or admire the club collection.</li>
